            ...
            <CardHeader>
                {goal === 'final-amount' ? (
                    <div>
                        ...
                        <CardDescription>Calculate the final amount of investment</CardDescription>
                    </div>
                ) : null}
                {goal === 'duration' ? (
                    <div>
                        <CardTitle>Duration</CardTitle>
                        <CardDescription>Calculate the time taken to reach investment goal</CardDescription>
                    </div>
                ) : null}
            </CardHeader>
